...
class ImageController extends AbstractController
{
    ...
    /**
     * @Route("/{id}/{rid}", name="admin_image_delete", methods={"DELETE"})
     */
    public function delete(Request $request, $rid, Image $image): Response
    {
       ...
       // die();
        ...
        return $this->redirectToRoute('admin_image_new', ['id'=>$rid]);
    }
}
